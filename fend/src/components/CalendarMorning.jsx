...
import ModalBookingMorning from "../Modals/ModalBookingMorning";

import "moment/locale/th";



function CalendarMorning() {
...
useEffect(() => {
  ...
  return (
    <div>
      ...
      {showModal && <ModalBookingMorning setOpenModal={setShowModal} dataday={valuesDay}/>}
    </div>
  );
}

export default CalendarMorning;